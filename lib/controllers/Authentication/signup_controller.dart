      ...
      await global.checkBody().then(
        (networkResult) async {
          if (networkResult) {
            ...
            global.user.fcmToken = await FirebaseMessaging.instance.getToken();
            global.user.appVersion = "1.0.0";
            global.user.appId = "1";
            global.user.deviceModel = global.deviceModel;
            global.user.deviceLocation =global.deviceLocation;
            global.user.deviceManufacturer =global.deviceManufacturer;
            global.user.deviceId =global.deviceId;

            print("global---test---device-->${global.user.fcmToken}");
            print("global---test---device-->${global.user.deviceModel}");
            print("global---test---device-->${global.user.deviceLocation}");
            print("global---test---device-->${global.user.deviceManufacturer}");
            print("global---test---device-->${global.user.deviceId}");
