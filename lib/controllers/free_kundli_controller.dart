  ...
  shareKundli(KundliModel userDetails) async {
    try {
      ...
      await FlutterShare.shareFile(
              ...
              text:
                  "Hey! I am using ${global.getSystemFlagValue(global.systemFlagNameList.appName)} to get predictions related to marriage/career.You should also try and see your future! $appShareLink")
          .then((value) {})
          .catchError((e) {
        print(e);
      });
