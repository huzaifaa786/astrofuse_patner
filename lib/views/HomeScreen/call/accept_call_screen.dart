...
class _AcceptCallScreenState extends State<AcceptCallScreen> {
  ...
  generateToken() async {
    try {
      ...
      await callController.getRtcToken(
          ...
          global.getSystemFlagValue(global.systemFlagNameList.agoraAppCertificate),
          "$uid",
    ...
    agoraEngine.registerEventHandler(
      RtcEngineEventHandler(
        onJoinChannelSuccess: (RtcConnection connection, int elapsed) {
          // ignore: avoid_print
          print('joined0---------------->${connection.localUid}');
          print('joined0---------------->${connection.channelId}');
          print('joined0---------------->${elapsed}');
        ...
        onRtcStats: (connection, stats) {
          // print("Ranjit--> ${connection.localUid}, ${stats.}")
        },
      ),
    );
    await generateToken();
  ...
  Widget status() {
    ...
    if (remoteUid == null) {
      ...
      return Text("The call has started");
      //   CountdownTimer(
