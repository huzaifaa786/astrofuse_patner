...
//Base url for api
String imgBaseurl = "https://astro.logy.lecenthealthcare.com/api/";
String pdfBaseurl = "https://astro.codefuse.org/";
String appMode = "LIVE";
String webBaseUrl = "https://astro.codefuse.org/";

Map<String, dynamic> appParameters = {
  "LIVE": {
    "apiUrl": "https://astro.logy.lecenthealthcare.com/api/",
  },
  "DEV": {
    "apiUrl": "https://astro.logy.lecenthealthcare.com/api/",
  }
...
String agoraAppId = "5ac7e1003bfd47d6beadb6383b3052de";
String agoraAppCertificate = "ee6cb1ea54a847b5a06a5538d62bfa57";
...
Future<bool> callOnFcmApiSendPushNotifications(
  ...
  try {
    ...
    //AAAAmwRvEy0:APA91bE_lDUJ8Llz9Y9QsWxp2pITgnjwNOeZ84U-GeWrCu99xT_SCXinqrCWMObYQiaMBMwtu9bMHdZhyD1G0g2HKgl_KEJqQpPzdcyfudZD-QERgFWaVDAMj3THPn1EOrMy2mDIXBTU
...
createAndShareLinkForDailyHorscope(ScreenshotController sc) async {
  ...
  final DynamicLinkParameters parameters = DynamicLinkParameters(
    ...
    androidParameters: const AndroidParameters(
      packageName: 'com.astrologgically.provider',
      minimumVersion: 1,
    ),
  );
  Uri url;
...
showToast({required String message}) async {
  var translation = await GoogleTranslator()
      .translate(message, to: splashController.currentLanguageCode);
