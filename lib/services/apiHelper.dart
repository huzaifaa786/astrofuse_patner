...
class APIHelper {
  ...
  Future<dynamic> signUp(CurrentUser user) async {
    print("SignUpUser Detils ---------> ${jsonEncode(user.toJson())}");

    try {
      print('${global.appParameters[global.appMode]['apiUrl']}astrologer/add');
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}astrologer/add"),
        headers: await global.getApiHeaders(false),
        body: json.encode(user.toJson()),
      );
      log('done signup-- : ${response.body}');
      dynamic recordList;
  ...
  Future<dynamic> validateSession() async {
    try {
      print(
          '${global.appParameters[global.appMode]['apiUrl']}validateSessionForAstrologer');
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}validateSessionForAstrologer"),
  ...
  Future<dynamic> setRemoteId(int astroId, int remoteId) async {
    try {
      ...
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}addAstrohost"),
        headers: await global.getApiHeaders(true),
        body: json.encode({
  ...
  Future astrologerUpdate(CurrentUser user) async {
    try {
      print(
          "${global.appParameters[global.appMode]['apiUrl']}astrologer/update");
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}astrologer/update"),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> checkExistContactNumber(String contactNo) async {
    try {
      print(
          '${global.appParameters[global.appMode]['apiUrl']}checkContactNoExist');
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}checkContactNoExist"),
        headers: await global.getApiHeaders(false),
  ...
  Future<dynamic> login(
      contactNo, DeviceInfoLoginModel userDeviceDetails) async {
    print("login -----> ${json.encode({
      "contactNo": contactNo,
    ...
    try {
      ...
      dynamic recordList;
      print("LoginCheck ---- release ---> ${response.body}");
  ...
  Future<dynamic> astrologerDelete(int id) async {
    try {
      print(
          "${global.appParameters[global.appMode]['apiUrl']}astrologer/delete");
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}astrologer/delete"),
        headers: await global.getApiHeaders(true),
...
//Master table
  Future getMasterTableData() async {
    try {
      ...
      print("hehr ${ global.getApiHeaders(false)}");
      print('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
        print(json.decode(response.body));
...
//get profile
  Future<dynamic> getAstrologerProfile(
    ...
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getAstrologerById"),
        headers: await global.getApiHeaders(true),
        body: json.encode({
          "astrologerId": id,
      ...
      dynamic recordList;
      print("getchatRequest---->0) ${response.body}");
      if (response.statusCode == 200) {
...
//--------------------------------Chat ---------------------------//
  ...
  Future<dynamic> getchatRequest(int id, int startIndex, int record) async {
    print("getchatRequest---->11) ${id}--${startIndex}---${record}");
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}chatRequest/get"),
        headers: await global.getApiHeaders(true),
        body: json.encode({
          "astrologerId": id,
          "startIndex": startIndex,
      ...
      print("getchatRequest---->11) ${response.body}");
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> chatReject(int chatId) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}chatRequest/reject"),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> acceptChatRequest(int chatId) async {
    print("getchatRequest---->11) ${chatId}--");
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}chatRequest/accept"),
        headers: await global.getApiHeaders(true),
        body: json.encode({"chatId": chatId}),
      );
      dynamic recordList;
      print("getchatRequest---->21) ${response.body}");
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getChatId(chatId) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}chatRequest/accept"),
      ...
      print("getchatRequest---->3) ${response.body}");
      dynamic recordList;
      if (response.statusCode == 200) {
        //recordList = List<ChatModel>.from(json.decode(response.body)["recordList"].map((x) => ChatModel.fromJson(x)));
      } else {
  ...
  Future<dynamic> addChatId(int userId, int partnerId, int chatId) async {
    print("getchatRequest---->11) ${userId}--${partnerId}---${chatId}");
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}chatRequest/storeChatId"),
        headers: await global.getApiHeaders(true),
        body: json.encode(
            {"userId": userId, "partnerId": partnerId, "chatId": chatId}),
      );
      print("getchatRequest---->41) ${response.body}");
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> addChatToken(
    ...
    print("getchatRequest---->511) ${token}---${channelName}--${chatId}");
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}chatRequest/storeToken"),
        headers: await global.getApiHeaders(true),
        body: json.encode(
            {"token": token, "channelName": channelName, "chatId": chatId}),
      );
      dynamic recordList;
      print("getchatRequest---->51) ${response.body}");
      if (response.statusCode == 200) {
        recordList = json.encode(response.body);
      } else {
        recordList = null;
...
//-------------------------- Call --------------------------------------//
  ...
  Future<dynamic> getCallRequest(int id, int startIndex, int record) async {
    print(
        "get Call Request--------- > ${id}-----${startIndex}------${record}--->");
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}callRequest/get"),
        headers: await global.getApiHeaders(true),
        body: json.encode({
          "astrologerId": id,
          "startIndex": startIndex,
      ...
      print("get Call Request--------- >0 ${response.body}");
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> acceptCallRequest(int callId) async {
    ...
    try {
      ...
      dynamic recordList;
      print("get Call Request--------- >1 ${response.body}");
      if (response.statusCode == 200) {
        //recordList = json.encode(response.body);
      } else {
        recordList = null;
  ...
  Future<dynamic> rejectCallRequest(int callId) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}callRequest/reject"),
        headers: await global.getApiHeaders(true),
        body: json.encode({"callId": callId}),
      );
      dynamic recordList;
      print("get Call Request--------- >2 ${response.body}");
      if (response.statusCode == 200) {
        recordList = json.encode(response.body);
      } else {
        recordList = null;
  ...
  Future<dynamic> addCallToken(String token, String channelName, int callId) async {
    log("call api token--> $token");
    log("call api channelName--> $channelName");
    log("call api callId--> $callId");
    ...
    try {
      ...
      log('addCallToken calling api ---> ${response.body}');
      print("get Call Request--------- >3 ${response.body}");
      dynamic recordList;
      if (response.statusCode == 200) {
        recordList = json.encode(response.body);
      } else {
...
//----------------------------- report ----------------------------------//
  ...
  Future<dynamic> getReportRequest(int id, int startIndex, int record) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getUserReport"),
        headers: await global.getApiHeaders(true),
        body: json.encode({
          "astrologerId": id,
          "startIndex": startIndex,
  ...
  Future sendReport(int id, String reportFile) async {
    try {
      ...
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}userreport/add"),
        headers: await global.getApiHeaders(true),
  ...
  Future addAstromallProdcut(ProductModel productModel) async {
    try {
      print(
          "${global.appParameters[global.appMode]['apiUrl']}astromallProduct/add");
      final response = await http.post(
          Uri.parse(
              "${global.appParameters[global.appMode]['apiUrl']}api/getproductCategory"),
          headers: await global.getApiHeaders(true),
  ...
  Future getproductCategory() async {
    try {
      print(
          "${global.appParameters[global.appMode]['apiUrl']}getproductCategory");
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getproductCategory"),
      );
...
//Add an astrologer assistant
  Future<dynamic> astrologerAssistantAdd(
    ...
    try {
      print(
          "${global.appParameters[global.appMode]['apiUrl']}astrologerAssistant/add");
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}astrologerAssistant/add"),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> getAstrologerAssistant(int id) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getAstrologerAssistant"),
        headers: await global.getApiHeaders(true),
...
//Update astrologer assistant
  Future astrologerAssistantUpdate(
    ...
    try {
      print(
          "${global.appParameters[global.appMode]['apiUrl']}astrologerAssistant/update");
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}astrologerAssistant/update"),
        headers: await global.getApiHeaders(true),
  ...
  Future getAssistantChatRequest(int astrologerId) async {
    try {
      print(
          "${global.appParameters[global.appMode]['apiUrl']}getAssistantChatRequest");
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getAssistantChatRequest"),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> assistantDelete(int id) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}astrologerAssistant/delete"),
        headers: await global.getApiHeaders(true),
        body: json.encode({"id": id}),
      );
      dynamic recordList;
  ...
  Future<dynamic> getHoroscope({int? horoscopeSignId}) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getDailyHoroscope"),
...
//get customer review for astrologer
  Future<dynamic> getCustomerReview(int id) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getAstrologerUserReview"),
        headers: await global.getApiHeaders(true),
        body: json.encode({"astrologerId": id}),
      );
      dynamic recordList;
  ...
  Future<dynamic> astrologerReply(int id, String reply) async {
    try {
      print(
          "${global.appParameters[global.appMode]['apiUrl']}userReview/reply");
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}userReview/reply"),
        headers: await global.getApiHeaders(true),
  ...
  Future sendLiveAstrologerToken(int astrologerId, String channelName,
    ...
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}liveAstrologer/add"),
        headers: await global.getApiHeaders(true),
        body: json.encode({
  ...
  Future<dynamic> getWaitList(String channel) async {
    print("test Chanal ----> ${channel}");
    try {
      final response = await http.post(
          Uri.parse(
              "${global.appParameters[global.appMode]['apiUrl']}waitlist/get"),
          body: {
            "channelName": channel,
          });
      dynamic recordList;
  ...
  Future sendLiveAstrologerChatToken(
    ...
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}liveAstrologer/livechattoken"),
        headers: await global.getApiHeaders(true),
        body: json.encode({
          "astrologerId": astrologerId,
          "channelName": channelName,
  ...
  Future endLiveSession(int astrologerId) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}liveAstrologer/endSession"),
        headers: await global.getApiHeaders(true),
        body: json.encode({"astrologerId": astrologerId}),
      );
      print('done : $response');
  ...
  Future<dynamic> getFollowersList(int id, int startIndex, int record) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getAstrologerFollower"),
        headers: await global.getApiHeaders(true),
        body: json.encode({
          "astrologerId": id,
          "startIndex": startIndex,
  ...
  Future<dynamic> withdrawAdd(
    ...
    try {
      print(
          "${global.appParameters[global.appMode]['apiUrl']}withdrawlrequest/add");
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}withdrawlrequest/add"),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> withdrawUpdate(
    ...
    try {
      print(
          "${global.appParameters[global.appMode]['apiUrl']}withdrawlrequest/update");
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}withdrawlrequest/update"),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> getWithdrawAmount(int id) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}withdrawlrequest/get"),
        headers: await global.getApiHeaders(true),
        body: json.encode({"astrologerId": id}),
      );
      dynamic recordList;
  ...
  Future<dynamic> getNotification(int startIndex, int record) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getUserNotification"),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> deleteNotification(int notificationId) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}userNotification/deleteUserNotification"),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> deleteAllNotification(int userId) async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}userNotification/deleteAllNotification"),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> getLiveUsers(String channelName) async {
    try {
      final response = await http.post(
        Uri.parse(
            '${global.appParameters[global.appMode]['apiUrl']}getLiveUser'),
        body: json.encode({"channelName": channelName}),
        headers: await global.getApiHeaders(false),
      );
      print('done get live: $response');
      print('done get live Response: ${response.body}');
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> addKundli(List<KundliModel> basicDetails) async {
    try {
      final response = await http.post(
        Uri.parse(
            '${global.appParameters[global.appMode]['apiUrl']}kundali/add'),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> updateKundli(int id, KundliModel basicDetails) async {
    try {
      final response = await http.post(
        Uri.parse(
            '${global.appParameters[global.appMode]['apiUrl']}kundali/update/$id'),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> deleteKundli(int id) async {
    try {
      final response = await http.post(
        Uri.parse(
            '${global.appParameters[global.appMode]['apiUrl']}kundali/delete'),
        body: json.encode({"id": "$id"}),
        headers: await global.getApiHeaders(true),
      );
      print('done : $response');
  ...
  Future<dynamic> getKundli() async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getkundali"),
        headers: await global.getApiHeaders(true),
      );
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getSystemFlag() async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getSystemFlag"),
      );
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> addCallWaitList(
    ...
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}addCallStatus"),
        headers: await global.getApiHeaders(true),
        // ignore: prefer_null_aware_operators
        body: json.encode({
          "astrologerId": astrologerId,
  ...
  Future<dynamic> getHororscopeSign() async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getHororscopeSign"),
        headers: await global.getApiHeaders(true),
      );
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> generateRtmToken(String agoraAppId,
    ...
    try {
      final response = await http.post(
        Uri.parse(
            '${global.appParameters[global.appMode]['apiUrl']}generateToken'),
        body: json.encode({
          "appID": agoraAppId,
  ...
  Future<dynamic> generateRtcToken(String agoraAppId,String agoraAppCertificate, String chatId, String channelName) async {
    print("agoraAppId--- >  ${agoraAppId}---${agoraAppCertificate}--${chatId}---${channelName}");
    try {
      final response = await http.post(
        Uri.parse(
            '${global.appParameters[global.appMode]['apiUrl']}generateRtcToken'),
        body: json.encode({
          "appID": agoraAppId,
          "appCertificate": agoraAppCertificate,
          "user": chatId,
  ...
  Future<dynamic> getBlog(
    ...
    try {
      final response = await http.post(
        Uri.parse(
            '${global.appParameters[global.appMode]['apiUrl']}getAppBlog'),
        headers: await global.getApiHeaders(false),
        body: json.encode({
  ...
  Future<dynamic> viewerCount(int id) async {
    try {
      final response = await http.post(
        Uri.parse(
            '${global.appParameters[global.appMode]['apiUrl']}addBlogReader'),
        headers: await global.getApiHeaders(true),
...
//get app review
  Future<dynamic> getAppReview() async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}appReview/get"),
        headers: await global.getApiHeaders(true),
  ...
  Future<dynamic> addAppFeedback(var basicDetails) async {
    try {
      final response = await http.post(
        Uri.parse(
            '${global.appParameters[global.appMode]['apiUrl']}appReview/add'),
        headers: await global.getApiHeaders(true),
        body: json.encode(basicDetails),
      );
      print(response);
  ...
  Future getLanguagesForMultiLanguage() async {
    try {
      final response = await http.post(
        Uri.parse(
            "${global.appParameters[global.appMode]['apiUrl']}getAppLanguage"),
      );
      print('done : $response');
      dynamic recordList;
      if (response.statusCode == 200) {
  ...
  Future<dynamic> getIntakedata(int id) async {
    try {
      final response = await http.post(
        Uri.parse(
            '${global.appParameters[global.appMode]['apiUrl']}chatRequest/getIntakeForm'),
        headers: await global.getApiHeaders(true),
